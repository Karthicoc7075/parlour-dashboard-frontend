...
<div className=" relative h-full px-3 py-4   dark:bg-gray-800 rounded-2xl bg-[#fff] shadow-md"> 
    ...
    <div className='flex gap-4 p-4 rounded-2xl bg-gray-100 dark:bg-gray-700 shadow-md'>
        <img src="http://iamkarthi.me/frontend/static/media/avatar-25.fbf48a8e618943324923.webp" alt="Logo" className="w-10 h-10 rounded-full" />
      ...
      <ul className="space-y-4 font-medium mt-6">
         <li>
            <a href="/dashboard" className={` ${pathname === '/dashboard' ? 'bg-gray-200 dark:bg-gray-700' : ''} flex items-center py-2 px-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group`}>
         ...
         <li>
            <a href="/dashboard/tasks" className={` ${pathname === '/dashboard/tasks' ? 'bg-gray-200 dark:bg-gray-700' : ''} flex items-center py-2 px-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group`}>
         ...
         <li>
            <a href="/dashboard/employees" className={` ${pathname === '/dashboard/employees' ? 'bg-gray-200 dark:bg-gray-700' : ''} flex items-center py-2 px-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group`}>
          ...
          <li>
            <a href="/dashboard/attendance" className={` ${pathname === '/dashboard/attendance' ? 'bg-gray-200 dark:bg-gray-700' : ''} flex items-center py-2 px-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group`}>
